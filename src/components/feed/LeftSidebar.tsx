const suggestedPeople = [
  { name: "Steve Jobs", role: "CEO of Apple", img: "/assets/images/people1.png", imgClass: "_info_img" },
  { name: "Ryan Roslansky", role: "CEO of Linkedin", img: "/assets/images/people2.png", imgClass: "_info_img1" },
  { name: "Dylan Field", role: "CEO of Figma", img: "/assets/images/people3.png", imgClass: "_info_img1" },
];
            ...
            <div className="_left_inner_area_suggest_info" key={person.name}>
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <a href="/profile">
                    <img src={person.img} alt="Image" className={person.imgClass} />
                  </a>
                </div>
